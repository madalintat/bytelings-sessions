"""Solved: apply — combine find_unused_imports + function_too_long."""
...
_gs = spec_from_file_location("_d130s_guided", _HERE / "guided.py")
_guided = module_from_spec(_gs)
sys.modules["_d130s_guided"] = _guided
_gs.loader.exec_module(_guided)

_ss = spec_from_file_location("_d130s_solo", _HERE / "solo.py")
_solo = module_from_spec(_ss)
sys.modules["_d130s_solo"] = _solo
