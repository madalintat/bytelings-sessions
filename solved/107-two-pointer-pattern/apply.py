...
The apply has no TODO; once solo.py's `remove_duplicates` is
implemented, the existing `is_palindrome` (already complete in the
starter) plus the dedup demonstration both run.
"""
