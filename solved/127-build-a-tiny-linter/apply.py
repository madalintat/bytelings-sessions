...
Lint one or more Python files and print findings in the standard
'path:line: CODE message' format (compatible with editor jump-to-error).

Exit code 0 if no issues, 1 if any findings or bad paths.

    uv run python apply.py path/to/file.py [more_files ...]
"""
